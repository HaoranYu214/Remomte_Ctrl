...
依据本地 [4200A-KXCI-907-01D，Rev. D，May 2024](smu/4200A-KXCI-907-01D_May_2024.pdf)。下文页码是手册印刷页码，例如 7-52 对应 PDF 第 173 页。章节 5 是 SMU，章节 7 是 PMU/PGU；本库的 PMU 注释采用 4225-PMU 条件，不能套用 PGU 的更短时序。
