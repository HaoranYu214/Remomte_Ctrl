...
- `../../reference/manuals/`: the local Keithley KXCI programming manual.
...
Manual locations in `reference/manuals/4200A-KXCI-907-01D_May_2024.pdf`:
...
可运行实验在 iv/，公共 KXCI 实现在 src/keithley4200/smu/。reference/manuals 保存本地编程手册，reference/official_examples/smu 保存用于对照的官方示例。正式入口不导入参考目录的 instrcomms.py，PMU/SMU 统一使用 src/keithley4200/transport.py。
...
本地 reference/manuals/4200A-KXCI-907-01D_May_2024.pdf 的印刷页码：
