...
"""Three-terminal FET transfer curves."""
...
MODE = "transfer"  # "output" or "transfer".
TURNING_POINTS = [-1.0, 1.0, -1.0]  # output: Vds path; transfer: Vgs path.
STEP = 0.05  # V; at most 4096 expanded points per curve.
FIXED_BIASES = [0.1]  # output: fixed Vgs; transfer: fixed Vds.
