...
# 阅读入口：ftj_RV1；先改本文件的 INST、CH1/CH2、params、CURRENT_RANGES 和 SAVE_DIR。
...
# 生成 0 → +Vp → 0 → −Vp → 0 的相对电压路径；Vp 的符号决定先扫哪侧。
...
# 合并 params_override 并生成波形，执行写电压扫描与逐点读回。
