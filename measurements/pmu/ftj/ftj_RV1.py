...
# Start here: ftj_RV1; edit INST, CH1/CH2, params, CURRENT_RANGES and SAVE_DIR.
...
# Generate relative voltage levels from zero to the target, excluding the initial zero.
...
# Build the relative path 0 -> +Vp -> 0 -> -Vp -> 0; the sign of Vp sets the first polarity.
...
# Merge params_override, build waveforms and execute a program-voltage sweep with a read at every point.
