...
# 阅读入口：ftj_PWM；先改本文件的 INST、CH1/CH2、params、CURRENT_RANGES 和 SAVE_DIR。
...
# 把一个波形块的电压、时间和采集窗口追加到已有序列数组；原地修改 target。
...
# 合并 params_override 并生成波形，执行固定写电压下的脉宽扫描与读回。
